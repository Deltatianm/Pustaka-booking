            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup"> 
                <div class="navbar-nav"> 
                    ...
                    if (!empty($this->session->userdata('email'))) { ?> 
                        <a class="nav-item nav-link" href="<?= base_url('booking'); ?>">Booking Buku <b><?=     $this->ModelBooking->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?></b> Buku</a> 
                        ...
                        <a class="nav-item nav-link" href="<?= base_url('member/logout'); ?>"><i class="fas fw fa-sign-out-alt"></i> Log out</a> 
 
                    <?php } else { ?> 
 
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#"> 
                        <i class="fas fw fa-sign-in-alt"></i> Daftar</a> 
